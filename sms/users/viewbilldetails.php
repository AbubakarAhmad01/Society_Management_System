  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>View Bill Detail's </h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="viewbills.php">Home</a></li>
              <li class="breadcrumb-item active">View Bill Detail's </li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row">
                ...
                <div class="col-12">
				 <?php $query=mysqli_query($con,"select  * from managebills where id='".$_GET['uid']."'");
$cnt=1;
	...
	<br>
              ...
              <div class="row no-print">
                <div class="col-12">
                  ...
                  <a href="payment.php?uid=<?php echo htmlentities($row['id']);?>"><button type="button" class="btn btn-success float-right"><i class="far fa-credit-card"></i> Pay Bill</button></a>
