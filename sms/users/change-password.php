              ...
              <form role="form" method="post" name="chngpwd" onSubmit="return valid();">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="password" name="password" required="required" placeholder="Enter Current Password" class="form-control">
                  </div>
                  <label for="newpswd">New Password </label>
                    <input type="password" name="newpassword" required="required" placeholder="Enter New Password" class="form-control">
               <label for="exampleInputEmail1">Confirm Password</label>
              <input type="password" name="confirmpassword" required="required" placeholder="Enter Confirm Password" class="form-control">
