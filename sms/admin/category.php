...
<?php } ?>
<!-- form start -->
              <form role="form" method="post" name="Category">
                <div class="card-body">
				 <div class="row">
				<div class="col-md-12">
...
?>									
										<tr>
											...
											<td>
											<a href="edit-category.php?id=<?php echo $row['id']?>" ><button type="button" class="btn btn-info">Edit </button></a>
											<a href="category.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><button type="button" class="btn btn-danger">Delete</button></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
